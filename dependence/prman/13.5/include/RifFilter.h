...
struct RifFilter
{
    	    	enum
		{
		    ...
		    /* Version 5 added RiSystem */
		    /* Version 6 added RiShader, RiCamera */
		    /* Version 7 added RiErrorHandler */
		    k_CurrentVersion = 7
		};
...
RtVoid		(*ErrorHandler)(RtErrorHandler);
  ...
  /*
  ** New members must ONLY be added at the end.  
  */
