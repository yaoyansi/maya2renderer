...
//Name: test_main.ma
//Last modified: Thu, Oct 21, 2010 11:27:41 AM
//Codeset: 936
requires maya "2008";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -47.834822886937012 15.202013163417764 2.2259419524668536 ;
	setAttr ".r" -type "double3" -17.138352729617768 -97.799999999999926 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 50.017267036578936;
...
createNode liquidLight -n "liquidLight1";
	...
	setAttr ".rlc" -type "stringArray" 6 "liquidAE_LifFloat2( \"intensity\", -1, \"float\", \"intensity\", {\"0\", \"0\"}, \"\", 1 );" "liquidAE_LifColor2( \"lightcolor\", -1, \"color\", \"lightcolor\", {\"0\", \"0\"}, \"\", 1 );" "liquidAE_LifFloat2( \"samples\", -1, \"float\", \"samples\", {\"0\", \"0\"}, \"\", 1 );" "liquidAE_LifVector2( \"center\", -1, \"point\", \"center\", {\"0\", \"0\"}, \"\", 1 );" "liquidAE_LifVector2( \"udir\", -1, \"vector\", \"udir\", {\"0\", \"0\"}, \"\", 1 );" "liquidAE_LifVector2( \"vdir\", -1, \"vector\", \"vdir\", {\"0\", \"0\"}, \"\", 1 );"  ;
...
createNode liquidSurface -n "liquidSurface3";
	...
	setAttr ".rpr" -type "stringArray" 3 "frequency" "s0" "v0"  ;
	setAttr ".rdt" -type "stringArray" 3 "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 3 "float" "string" "vector"  ;
	setAttr ".rdf" -type "stringArray" 3 "4.0" "test string" "1.0000002.0000003.000000"  ;
	setAttr ".ras" -type "Int32Array" 3 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 3 "liquidAE_LifFloat2( \"frequency\", -1, \"float\", \"frequency\", {\"0\", \"0\"}, \"\", 1 );" "liquidAE_LifString2( \"s0\", -1, \"string\", \"s0\", {\"0\", \"0\"}, \"\", 1 );" "liquidAE_LifVector2( \"v0\", -1, \"vector\", \"v0\", {\"0\", \"0\"}, \"\", 1 );"  ;
	setAttr ".rmt" -type "stringArray" 1 "surface"  ;
...
connectAttr "pSphereShape3.iog" "liquidSurface3SG.dsm" -na;
connectAttr "liquidSurface3SG.msg" "materialInfo5.sg";
connectAttr "liquidSurface3.msg" "materialInfo5.m";
connectAttr "liquidSurface3.msg" "materialInfo5.t" -na;
