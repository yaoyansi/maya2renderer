...
//Name: test_main.ma
//Last modified: Thu, Oct 28, 2010 11:17:38 AM
//Codeset: 936
requires maya "2008";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -16.235208842531744 5.3665443484054061 6.5545506393137547 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fs" 10.372;
	setAttr ".fd" 35;
	setAttr ".coi" 16.640495057696899;
