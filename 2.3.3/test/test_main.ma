...
//Name: test_main.ma
//Last modified: Thu, Oct 28, 2010 02:04:25 PM
//Codeset: 936
requires maya "2008";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -28.851290968010552 14.918153321048187 4.4220020330688454 ;
	setAttr ".r" -type "double3" -26.738352729610352 -98.59999999999809 0 ;
...
connectAttr "pCubeShape2.iog" "liquidSurface8SG.dsm" -na;
connectAttr "pCubeShape3.iog" "liquidSurface8SG.dsm" -na;
