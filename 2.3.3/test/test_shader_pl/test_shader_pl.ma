...
//Last modified: Sun, Feb 19, 2012 04:04:02 PM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=13:48:41.07)";
...
createNode liquidSurface -n "liquidSurface17";
	...
	setAttr ".rpr" -type "stringArray" 3 "frequency" "mode" "mode2"  ;
	setAttr ".rdt" -type "stringArray" 3 "uniform" "uniform" "uniform"  ;
	setAttr ".rty" -type "stringArray" 3 "float" "float" "float"  ;
	setAttr ".rdf" -type "stringArray" 3 "8.5" "0.0" "0.5"  ;
	setAttr ".ras" -type "Int32Array" 3 -1 -1 -1 ;
	setAttr ".rlc" -type "stringArray" 3 "liquidAE_LifFloat( \"frequency\", -1, \"float\", \"frequency\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"mode\", -1, \"float\", \"mode\", {\"0\", \"0\"}, \"\", 14 );" "liquidAE_LifFloat( \"mode2\", -1, \"float\", \"mode2\", {\"0\", \"0\"}, \"\", 14 );"  ;
...
connectAttr "liquidSurface17.oc" "liquidSurface19SG.ss";
connectAttr "pPlaneShape11.iog" "liquidSurface19SG.dsm" -na;
connectAttr "liquidSurface19SG.msg" "materialInfo11.sg";
connectAttr "liquidSurface17.msg" "materialInfo11.m";
connectAttr "liquidSurface17.msg" "materialInfo11.t" -na;
