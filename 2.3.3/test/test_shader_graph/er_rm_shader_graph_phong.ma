...
//Name: er_rm_shader_graph_simple.ma
//Last modified: Sat, Mar 10, 2012 04:44:04 PM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime=16:41:17.59)";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.5599521638798919 43.066304978153475 21.018590676948683 ;
	setAttr ".r" -type "double3" -65.138352729605032 9.0000000000000835 8.0505017391089558e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 45.916379541740035;
...
createNode liquidGlobals -n "liquidGlobals";
	...
	setAttr ".lrs" -type "string" "E:/MyDocuments/maya/projects/default/rmantmp/er_rm_shader_graph_simple.xml";
...
createNode phong -n "phong1";
	...
	setAttr ".dc" 0.60329997539520264;
	setAttr ".c" -type "float3" 0 0 0 ;
	setAttr ".it" -type "float3" 0.066119999 0.066119999 0.066119999 ;
	setAttr ".ambc" -type "float3" 0.12396 0.12396 0.12396 ;
	setAttr ".ic" -type "float3" 0.08264 0.08264 0.08264 ;
	setAttr ".tc" 0.041319999843835831;
	setAttr ".tcf" 0.55371999740600586;
	setAttr ".trsd" 0.74383997917175293;
	setAttr ".sc" -type "float3" 0.42148 0.42148 0.42148 ;
	setAttr ".rfl" 0.40498000383377075;
	setAttr ".rc" -type "float3" 0.074380003 0.074380003 0.074380003 ;
	setAttr ".cp" 23.870000839233398;
...
// End of er_rm_shader_graph_simple.ma
