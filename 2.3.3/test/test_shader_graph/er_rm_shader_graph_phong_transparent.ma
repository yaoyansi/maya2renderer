...
//Last modified: Mon, Mar 12, 2012 01:31:21 AM
//Codeset: 936
requires maya "2009";
requires "liquid_2009x32d" "2.3.5 (buildtime= 1:15:25.50)";
...
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" -60.338352729608182 -1.3999999999997605 2.9826603684712958e-016 ;
...
createNode pointLight -n "pointLightShape1" -p "pointLight1";
	setAttr -k off ".v";
	setAttr ".in" 0.02500000037252903;
	setAttr ".us" no;
